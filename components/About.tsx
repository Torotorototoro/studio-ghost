...
export default function About() {
  ...
  return (
    <section
      ...
      style={style}
    >
      <SectionBackground src="/photos/about.jpg" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="inline-flex items-center gap-2 mb-6 px-3 py-1 rounded-full border border-white/10 bg-black/30">
          ...
          <span className="text-[10px] tracking-[0.2em] text-slate-400 uppercase">Philosophy</span>
        </div>
        ...
        <div className="space-y-8 mb-16">
          <div className="glass-card p-8">
            <h3 className="text-xs tracking-[0.2em] text-slate-400 uppercase mb-4 font-semibold">
              Problem
            </h3>
