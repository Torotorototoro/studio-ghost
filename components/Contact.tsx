      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        ...
        <div className="glass-card p-8 sm:p-10">
          <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
            <div>
              <label htmlFor="name" className="block text-[10px] tracking-[0.2em] text-slate-400 uppercase mb-2 font-semibold">
                Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="email" className="block text-[10px] tracking-[0.2em] text-slate-400 uppercase mb-2 font-semibold">
                Email
              </label>
              <input
                id="email"
            ...
            <div>
              <label htmlFor="message" className="block text-[10px] tracking-[0.2em] text-slate-400 uppercase mb-2 font-semibold">
                Message
              </label>
              <textarea
                id="message"
